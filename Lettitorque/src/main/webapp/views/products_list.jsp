        ...
        %>
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2 product-card">
                <div class="card">
                    ...
                    <% } %>
                    <div class="card-body"> <!-- Reduced padding to reduce space inside the card -->
                        ...
                        <p class="card-text product-attribute"><strong>Category:</strong> <%= prod.getCategory().getName() %></p> <!-- Assuming Category has a getName method -->
                    </div>
                </div>
